# Gradient: Roots - Character Creation 
...
A Character's _Background_ and _Specialization_ represent fantasy archetypes and provides modifiers for [Attributes & Hit Protection](#modify-attributes-hit-protection-and-roll-for-traits-bonds-age-and-omens) and starting [Inventory](#starting-inventory).

If rolling random, first roll a **d6** to determine your _Background_, then roll a **d4** to determine your _Specialization_.
...
- Add and Subtract your _Background Bonuses_ to/from your **Attributes** and **Hit Protection**.
- Roll for the rest of your character's [Traits](#character-traits), and then on the the [Bonds](#bonds-d20) table.
- Finally, roll for your character's **Age** (2d20+10). If you are the _youngest_ character, roll on the [Omens](#omens-d20) table. The result should be read aloud to the other players. The Warden should incorporate Omens into the setting as they see fit.

## Starting Inventory

- Add your Background's **Starting Gear** and **Signature Inventory Items** to your inventory.

## Character Traits

The Character Trait tables can be used for inspiration, or you can generate traits at random. 

To roll randomly, use the dice indicated by each table (for example, d2, d10, d66):
- For tables labeled d2, flip a coin. For d4 through d20, just roll a die with the indicated number of sides.
- For d66 tables, roll two six-sided dice (d6). The first die tells you which "group" or sub-table to use, and the second die tells you which row in that group to pick. (For example, a roll of 4 and 5 means look in group 4, row 5.)

### Lineage (d2)

|       |          |        |            |
| ----- | -------- | ------ | ---------- |
| **1** | Lowborne | **2**  | Highborne  |
...
### Female First Names (d66)

TBD.

### Male First Names (d66)

TBD.

### Lowborne Surnames (d66)

TBD.

### Highborne Surnames (d66)
